...
public class QuailConfig {
    ...
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder){
            ...
            builder.push("World gen options").push("World");
            quailWeight = builder
            ...
            builder.comment("Options for quail eggs").push("QuailEgg");
            ...
            quailEggMultiChance = builder
                    .comment("Chance for egg to spawn 8 quails instead of 1")
                    .worldRestart()
