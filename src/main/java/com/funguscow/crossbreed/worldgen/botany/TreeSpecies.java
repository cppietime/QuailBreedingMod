...
public class TreeSpecies implements IngredientLike {
    ...
    public static final TreeSpecies
            PINE = new TreeSpecies("pine", new ResourceLocation(BreedMod.MODID, "pine_log"),
            new ResourceLocation(BreedMod.MODID, "pine_leaves"), 2,
            new TreeGene(1,
                    4,
                    1.0,
                    "pine",
            ...
            ALDER = new TreeSpecies("alder",
                    ...
                    new ResourceLocation(BreedMod.MODID, "alder_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            0.6,
            ...
            HAZEL = new TreeSpecies("hazel",
                    new ResourceLocation(BreedMod.MODID, "alder_log"),
                    new ResourceLocation(BreedMod.MODID, "hazel_leaves"),
                    2,
                    new TreeGene(1,
                            3,
                            1,
            ...
            HORNBEAM = new TreeSpecies("hornbeam",
                    new ResourceLocation(BreedMod.MODID, "alder_log"),
                    new ResourceLocation(BreedMod.MODID, "hornbeam_leaves"),
                    2,
                    new TreeGene(2,
                            4,
                            0.5,
            ...
            WHITE_OAK = new TreeSpecies("white_oak",
                    new ResourceLocation("oak_log"),
                    new ResourceLocation(BreedMod.MODID, "white_oak_leaves"),
                    2,
                    new TreeGene(3,
                            8,
                            1,
            ...
            BEECH = new TreeSpecies("beech",
                    new ResourceLocation("birch_log"),
                    new ResourceLocation(BreedMod.MODID, "beech_leaves"),
                    2,
                    new TreeGene(2,
                            4,
                            1,
            ...
            HICKORY = new TreeSpecies("hickory",
                    new ResourceLocation(BreedMod.MODID, "walnut_log"),
                    new ResourceLocation(BreedMod.MODID, "hickory_leaves"),
                    2,
                    new TreeGene(1,
                            6,
                            1,
            ...
            PECAN = new TreeSpecies("pecan",
                    new ResourceLocation(BreedMod.MODID, "walnut_log"),
                    new ResourceLocation(BreedMod.MODID, "pecan_leaves"),
                    2,
                    new TreeGene(1,
                            7,
                            0.5,
            ...
            PEAR = new TreeSpecies("pear",
                    new ResourceLocation(BreedMod.MODID, "apple_log"),
                    new ResourceLocation(BreedMod.MODID, "pear_leaves"),
                    2,
                    new TreeGene(1,
                            5,
                            0.5,
            ...
            QUINCE = new TreeSpecies("quince",
                    new ResourceLocation(BreedMod.MODID, "apple_log"),
                    new ResourceLocation(BreedMod.MODID, "quince_leaves"),
                    2,
                    new TreeGene(1,
                            5,
                            0.8,
            ...
            PLUM = new TreeSpecies("plum",
                    ...
                    new ResourceLocation(BreedMod.MODID, "plum_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            0.8,
            ...
            ALMOND = new TreeSpecies("almond",
                    new ResourceLocation(BreedMod.MODID, "plum_log"),
                    new ResourceLocation(BreedMod.MODID, "almond_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            0.8,
            ...
            PEACH = new TreeSpecies("peach",
                    new ResourceLocation(BreedMod.MODID, "plum_log"),
                    new ResourceLocation(BreedMod.MODID, "peach_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            0.8,
            ...
            APRICOT = new TreeSpecies("apricot",
                    new ResourceLocation(BreedMod.MODID, "plum_log"),
                    new ResourceLocation(BreedMod.MODID, "apricot_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            0.8,
            ...
            YEW = new TreeSpecies("yew",
                    ...
                    new ResourceLocation(BreedMod.MODID, "yew_leaves"),
                    2,
                    new TreeGene(2,
                            2,
                            0.5,
            ...
            MYRTLE = new TreeSpecies("myrtle",
                    new ResourceLocation("mangrove_log"),
                    new ResourceLocation(BreedMod.MODID, "myrtle_leaves"),
                    2,
                    new TreeGene(1,
                            3,
                            0.7,
            ...
            HEMLOCK = new TreeSpecies("hemlock",
                    new ResourceLocation(BreedMod.MODID, "pine_log"),
                    new ResourceLocation(BreedMod.MODID, "hemlock_leaves"),
                    2,
                    new TreeGene(1,
                            5,
                            2,
            ...
            FIR = new TreeSpecies("fir",
                    new ResourceLocation(BreedMod.MODID, "pine_log"),
                    new ResourceLocation(BreedMod.MODID, "fir_leaves"),
                    2,
                    new TreeGene(2,
                            5,
                            2,
            ...
            SUMAC = new TreeSpecies("sumac",
                    ...
                    new ResourceLocation(BreedMod.MODID, "sumac_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            2,
            ...
            CASHEW = new TreeSpecies("cashew",
                    new ResourceLocation(BreedMod.MODID, "sumac_log"),
                    new ResourceLocation(BreedMod.MODID, "cashew_leaves"),
                    2,
                    new TreeGene(1,
                            3,
                            0.4,
            ...
            PISTACHIO = new TreeSpecies("pistachio",
                    new ResourceLocation(BreedMod.MODID, "sumac_log"),
                    new ResourceLocation(BreedMod.MODID, "pistachio_leaves"),
                    2,
                    new TreeGene(2,
                            3,
                            0.7,
            ...
            MANGO = new TreeSpecies("mango",
                    new ResourceLocation(BreedMod.MODID, "sumac_log"),
                    new ResourceLocation(BreedMod.MODID, "mango_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            HORSE_CHESTNUT = new TreeSpecies("horse_chestnut",
                    new ResourceLocation(BreedMod.MODID, "maple_log"),
                    new ResourceLocation(BreedMod.MODID, "horse_chestnut_leaves"),
                    2,
                    new TreeGene(1,
                            7,
                            0.3,
            ...
            LYCHEE = new TreeSpecies("lychee",
                    new ResourceLocation(BreedMod.MODID, "maple_log"),
                    new ResourceLocation(BreedMod.MODID, "lychee_leaves"),
                    2,
                    new TreeGene(2,
                            4,
                            0.5,
            ...
            RAMBUTAN = new TreeSpecies("rambutan",
                    new ResourceLocation(BreedMod.MODID, "maple_log"),
                    new ResourceLocation(BreedMod.MODID, "rambutan_leaves"),
                    2,
                    new TreeGene(2,
                            4,
                            0.5,
            ...
            ACKEE = new TreeSpecies("ackee",
                    new ResourceLocation(BreedMod.MODID, "maple_log"),
                    new ResourceLocation(BreedMod.MODID, "ackee_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            0.5,
            ...
            CLOVE = new TreeSpecies("clove",
                    new ResourceLocation("mangrove_log"),
                    new ResourceLocation(BreedMod.MODID, "clove_leaves"),
                    1,
                    new TreeGene(1,
                            4,
                            0.8,
            ...
            ALLSPICE = new TreeSpecies("allspice",
                    new ResourceLocation("mangrove_log"),
                    new ResourceLocation(BreedMod.MODID, "allspice_leaves"),
                    1,
                    new TreeGene(1,
                            4,
                            0.8,
            ...
            POMEGRANATE = new TreeSpecies("pomegranate",
                    new ResourceLocation("mangrove_log"),
                    new ResourceLocation(BreedMod.MODID, "pomegranate_leaves"),
                    1,
                    new TreeGene(1,
                            2,
                            1,
            ...
            EUCALYPTUS = new TreeSpecies("eucalyptus",
                    ...
                    new ResourceLocation(BreedMod.MODID, "eucalyptus_leaves"),
                    2,
                    new TreeGene(3,
                            6,
                            0.8,
            ...
            MIMOSA = new TreeSpecies("mimosa",
                    ...
                    new ResourceLocation(BreedMod.MODID, "mimosa_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            CAROB = new TreeSpecies("carob",
                    new ResourceLocation(BreedMod.MODID, "carob_log"),
                    new ResourceLocation(BreedMod.MODID, "carob_leaves"),
                    2,
                    new TreeGene(2,
                            6,
                            0.8,
            ...
            BLACK_LOCUST = new TreeSpecies("black_locust",
                    new ResourceLocation(BreedMod.MODID, "carob_log"),
                    new ResourceLocation(BreedMod.MODID, "black_locust_leaves"),
                    2,
                    new TreeGene(2,
                            8,
                            0.4,
            ...
            CACAO = new TreeSpecies("cacao",
                    new ResourceLocation("jungle_log"),
                    new ResourceLocation(BreedMod.MODID, "cacao_leaves"),
                    2,
                    new TreeGene(4,
                            4,
                            0.8,
            ...
            DURIAN = new TreeSpecies("durian",
                    new ResourceLocation("jungle_log"),
                    new ResourceLocation(BreedMod.MODID, "durian_leaves"),
                    2,
                    new TreeGene(2,
                            6,
                            0.8,
            ...
            EBONY = new TreeSpecies("ebony",
                    ...
                    new ResourceLocation(BreedMod.MODID, "ebony_leaves"),
                    2,
                    new TreeGene(4,
                            4,
                            1,
            ...
            PERSIMMON = new TreeSpecies("persimmon",
                    new ResourceLocation(BreedMod.MODID, "ebony_log"),
                    new ResourceLocation(BreedMod.MODID, "persimmon_leaves"),
                    2,
                    new TreeGene(1,
                            6,
                            0.3,
            ...
            MAHOGANY = new TreeSpecies("mahogany",
                    ...
                    new ResourceLocation(BreedMod.MODID, "mahogany_leaves"),
                    2,
                    new TreeGene(3,
                            7,
                            1,
            ...
            MANDARIN = new TreeSpecies("mandarin",
                    ...
                    new ResourceLocation(BreedMod.MODID, "mandarin_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            POMELO = new TreeSpecies("pomelo",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "pomelo_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            CITRON = new TreeSpecies("citron",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "citron_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            PAPEDA = new TreeSpecies("papeda",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "papeda_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            SWEET_ORANGE = new TreeSpecies("sweet_orange",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "orange_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            BITTER_ORANGE = new TreeSpecies("bitter_orange",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "bitter_orange_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            GRAPEFRUIT = new TreeSpecies("grapefruit",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "grapefruit_leaves"),
                    2,
                    new TreeGene(2,
                            4,
                            1,
            ...
            LEMON = new TreeSpecies("lemon",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "lemon_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            LIME = new TreeSpecies("lime",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "lime_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            1,
            ...
            KUMQUAT = new TreeSpecies("kumquat",
                    new ResourceLocation(BreedMod.MODID, "citrus_log"),
                    new ResourceLocation(BreedMod.MODID, "kumquat_leaves"),
                    2,
                    new TreeGene(1,
                            3,
                            0.7,
                            ...
                            0.05,
                            0.14)),
            CEDAR = new TreeSpecies("cedar",
                    new ResourceLocation(BreedMod.MODID, "pine_log"),
                    new ResourceLocation(BreedMod.MODID, "cedar_leaves"),
                    2,
                    new TreeGene(1,
                            4,
                            2,
                            ...
                            0.05,
                            0.14)),
            JUNIPER = new TreeSpecies("juniper",
                    new ResourceLocation(BreedMod.MODID, "pine_log"),
                    new ResourceLocation(BreedMod.MODID, "juniper_leaves"),
                    2,
                    new TreeGene(1,
                            2,
                            0,
                            ...
                            "straight",
                            "snake",
                            "breesources:juniper_berry",
                            0.01,
                            0.05,
                            0.3)),
            SEQUOIA = new TreeSpecies("sequoia",
                    new ResourceLocation(BreedMod.MODID, "redwood_log"),
                    new ResourceLocation(BreedMod.MODID, "redwood_leaves"),
                    3,
                    new TreeGene(5,
                            25,
                            3,
                            ...
                            0.0125,
                            0.05)),
            HIBISCUS = new TreeSpecies("hibiscus",
                    new ResourceLocation("jungle_log"),
                    new ResourceLocation(BreedMod.MODID, "hibiscus_leaves"),
                    2,
                    new TreeGene(1,
                            2,
                            1,
                            ...
                            0.05,
                            0.14)),
            BAOBAB = new TreeSpecies("baobab",
                    new ResourceLocation(BreedMod.MODID, "baobab_log"),
                    new ResourceLocation(BreedMod.MODID, "baobab_leaves"),
                    3,
                    new TreeGene(6,
                            5,
                            5,
                            ...
                            0.0125,
                            0.05)),
            RAINBOW_EUCALYPTUS = new TreeSpecies("rainbow_eucalyptus",
                    new ResourceLocation(BreedMod.MODID, "rainbow_eucalyptus_log"),
                    new ResourceLocation(BreedMod.MODID, "eucalyptus_leaves"),
                    2,
                    new TreeGene(3,
                            4,
    ...
    static {
        ...
        registerPair(CACAO, MAHOGANY, HIBISCUS, 0.5f);
        registerPair(HIBISCUS, DURIAN, BAOBAB, 0.2f);
        registerPair(EUCALYPTUS, HIBISCUS, RAINBOW_EUCALYPTUS, 0.1f);
        registerPair(HEMLOCK, FIR, CEDAR, 0.5f);
        registerPair(CEDAR, YEW, JUNIPER, 0.5f);
        registerPair(CEDAR, EUCALYPTUS, SEQUOIA, 0.1f);
    }
