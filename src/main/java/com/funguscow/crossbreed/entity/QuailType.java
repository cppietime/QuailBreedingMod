...
//        }
    ...
    public static Item getItem(String id, Random rand){
        ...
        if("#@".contains(id.substring(0, 1))){
            ITag<Item> tag = ItemTags.getCollection().get(new ResourceLocation(id.substring(1)));
            if(tag == null)
                return null;
    ...
    public ItemStack getLoot(Random rand, QuailEntity.Gene gene){
    ...
    public static final QuailType
            ...
            INK = new QuailType("ink", "minecraft:ink_sack", 1, 0, 4800),
            BEET = new QuailType("beet", "minecraft:beetroot", 1, 0, 4800, "minecraft:beetroot_seeds", 1),
            CACTUS = new QuailType("cactus", "minecraft:cactus", 1, 0, 4800),
            LAPIS = new QuailType("lapis", "minecraft:lapis_lazuli", 1, 0, 4800),
            FLOWER = new QuailType("flower", "@breesources:normal_flowers", 1, 0, 4800, "minecraft:rabbit", 1),
            IRON = new QuailType("iron", "minecraft:iron_ingot", 1, 0, 4800, "minecraft:poppy", 1),
            REDSTONE = new QuailType("redstone", "minecraft:redstone", 1, 2, 4800),
            SOULSAND = new QuailType("soulsand", "minecraft:soul_sand", 1, 0, 4800),
            WHEAT = new QuailType("wheat", "minecraft:wheat", 1, 0, 4800, "minecraft:wheat_seeds", 1),
            MELON = new QuailType("melon", "minecraft:melon_slice", 1, 2, 4800),
            ...
            // Modded
            COPPER = new QuailType("copper", "#forge:ingots/copper", 1, 0, 4800).disable(),
            ...
            GLOWSTONE = new QuailType("glowstone", "minecraft:glowstone_dust", 1, 3, 6000),
            ...
            PRISM = new QuailType("prism", "minecraft:prismarine_shard", 1, 3, 24000, "minecraft:prismarine_crystals", 2),
            ...
            CHORUS = new QuailType("chorus", "minecraft:chorus_fruit", 1, 3, 24000, "minecraft:chorus_flower", 1),
            ...
            BLUE_DYE = new QuailType("blue_dye", "minecraft:blue_dye", 2, 2, 4800),
            ...
            RED_CONCRETE_POWDER = new QuailType("red_concrete_powder", "minecraft:red_concrete_powder", 1, 0, 2400),
            GREEN_CONCRETE_POWDER = new QuailType("green_concrete_powder", "minecraft:green_concrete_powder", 1, 0, 2400),
            BLUE_CONCRETE_POWDER = new QuailType("blue_concrete_powder", "minecraft:blue_concrete_powder", 1, 0, 2400),
            YELLOW_CONCRETE_POWDER = new QuailType("yellow_concrete_powder", "minecraft:yellow_concrete_powder", 1, 0, 2400),
            BROWN_CONCRETE_POWDER = new QuailType("brown_concrete_powder", "minecraft:brown_concrete_powder", 1, 0, 2400),
            PINK_CONCRETE_POWDER = new QuailType("pink_concrete_powder", "minecraft:pink_concrete_powder", 1, 0, 2400),
            ORANGE_CONCRETE_POWDER = new QuailType("orange_concrete_powder", "minecraft:orange_concrete_powder", 1, 0, 2400),
            PURPLE_CONCRETE_POWDER = new QuailType("purple_concrete_powder", "minecraft:purple_concrete_powder", 1, 0, 2400),
            MAGENTA_CONCRETE_POWDER = new QuailType("magenta_concrete_powder", "minecraft:magenta_concrete_powder", 1, 0, 2400),
            ...
            RED_CONCRETE = new QuailType("red_concrete", "minecraft:red_concrete", 1, 0, 4800),
            GREEN_CONCRETE = new QuailType("green_concrete", "minecraft:green_concrete", 1, 0, 4800),
            BLUE_CONCRETE = new QuailType("blue_concrete", "minecraft:blue_concrete", 1, 0, 4800),
            YELLOW_CONCRETE = new QuailType("yellow_concrete", "minecraft:yellow_concrete", 1, 0, 4800),
            BROWN_CONCRETE = new QuailType("brown_concrete", "minecraft:brown_concrete", 1, 0, 4800),
            PINK_CONCRETE = new QuailType("pink_concrete", "minecraft:pink_concrete", 1, 0, 4800),
            ORANGE_CONCRETE = new QuailType("orange_concrete", "minecraft:orange_concrete", 1, 0, 4800),
            PURPLE_CONCRETE = new QuailType("purple_concrete", "minecraft:purple_concrete", 1, 0, 4800),
            MAGENTA_CONCRETE = new QuailType("magenta_concrete", "minecraft:magenta_concrete", 1, 0, 4800),
            LIME_CONCRETE = new QuailType("lime_concrete", "minecraft:lime_concrete", 1, 0, 4800),
            ...
            RED_WOOL = new QuailType("red_wool", "minecraft:red_wool", 1, 0, 4800),
            GREEN_WOOL = new QuailType("green_wool", "minecraft:green_wool", 1, 0, 4800),
            BLUE_WOOL = new QuailType("blue_wool", "minecraft:blue_wool", 1, 0, 4800),
            YELLOW_WOOL = new QuailType("yellow_wool", "minecraft:yellow_wool", 1, 0, 4800),
            BROWN_WOOL = new QuailType("brown_wool", "minecraft:brown_wool", 1, 0, 4800),
            PINK_WOOL = new QuailType("pink_wool", "minecraft:pink_wool", 1, 0, 4800),
            ORANGE_WOOL = new QuailType("orange_wool", "minecraft:orange_wool", 1, 0, 4800),
            PURPLE_WOOL = new QuailType("purple_wool", "minecraft:purple_wool", 1, 0, 4800),
            MAGENTA_WOOL = new QuailType("magenta_wool", "minecraft:magenta_wool", 1, 0, 4800),
            LIME_WOOL = new QuailType("lime_wool", "minecraft:lime_wool", 1, 0, 4800),
