...
public class ModItems {
    ...
    public static final RegistryObject<Item> QUAIL_EGG = ITEMS.register("quail_egg",
            () -> new GenericEggItem(new Item.Properties().tab(BreedMod.GROUP),
                    1,
                    1000,
                    "breesources:quail",
                    "breesources:quail_egg")),
            WATER_BUBBLE = ITEMS.register("water_bubble",
                    () -> new BubbleItem(new Item.Properties().tab(BreedMod.GROUP),
                            Fluids.WATER)),
            LAVA_BUBBLE = ITEMS.register("lava_bubble",
                    () -> new BubbleItem(new Item.Properties().tab(BreedMod.GROUP),
                            Fluids.LAVA)),
            QUAIL_JAIL = ITEMS.register("quail_jail",
                    () -> new JailItem(new Item.Properties().stacksTo(1).tab(BreedMod.GROUP), false)),
            STRONG_QUAIL_JAIL = ITEMS.register("strong_quail_jail",
                    () -> new JailItem(new Item.Properties().stacksTo(1).tab(BreedMod.GROUP), true)),
            PICKLED_EGG = ITEMS.register("pickled_egg",
                    () -> new Item(new Item.Properties().tab(BreedMod.GROUP).food(
            ...
            RAW_QUAIL = ITEMS.register("raw_quail",
                    () -> new Item(new Item.Properties().tab(BreedMod.GROUP).food(Foods.CHICKEN))),
            COOKED_QUAIL = ITEMS.register("cooked_quail",
                    () -> new Item(new Item.Properties().tab(BreedMod.GROUP).food(Foods.COOKED_CHICKEN))),
            QUAIL_METER = ITEMS.register("quail_meter",
                    () -> new MeterItem(new Item.Properties().tab(BreedMod.GROUP).stacksTo(1))),
