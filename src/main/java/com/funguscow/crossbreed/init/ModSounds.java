...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> QUAIL_AMBIENT = SOUNDS.register("quail_ambient",
            () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("breesources", "quail_ambient"))),
            QUAIL_HURT = SOUNDS.register("quail_hurt",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("breesources", "quail_hurt"))),
            QUAIL_DIE = SOUNDS.register("quail_die",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("breesources", "quail_die"))),
            QUAIL_STEP = SOUNDS.register("quail_step",
                    () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("breesources", "quail_step"))),
